    ...
    void 피드_전체조회_테스트_어드민_페이징() {
        ...
        List<Feed> feeds = List.of(
                LandingFeed.builder()
                        .id(1L)
                        .admin(admin)
                        .category(Category.builder().categoryName("hello").build())
                ...
                LandingFeed.builder()
                        .id(2L)
                        .admin(admin)
                        .category(Category.builder().categoryName("world").build())
                        .feedType(FeedType.LANDING.toString())
                        .activated(FeedStatus.POSTING)
                ...
                CurationFeed.builder()
                        .id(3L)
                        .admin(admin)
                        .category(Category.builder().categoryName("helloWorld").build())
                        .subTitle("testTitle2")
                        .activated(FeedStatus.POSTING)
