...
import static com.depromeet.breadmapbackend.domain.post.PostControllerAssertions.빵_이야기_상세_조회_요청_결과_검증;
import static com.depromeet.breadmapbackend.domain.post.PostControllerAssertions.빵_이야기_작성_요청_결과_검증;
import static com.depromeet.breadmapbackend.domain.post.PostControllerAssertions.커뮤니티_글_삭제_요청_결과_검증;
import static com.depromeet.breadmapbackend.domain.post.PostControllerAssertions.커뮤니티_글_수정_요청_결과_검증;
import static com.depromeet.breadmapbackend.domain.post.PostControllerAssertions.커뮤니티_글_좋아요_요청_결과_검증;
import static com.depromeet.breadmapbackend.domain.post.PostControllerAssertions.커뮤니티_전체_카테고리_조회_요청_결과_검증;
import static com.depromeet.breadmapbackend.domain.post.PostControllerAssertions.커뮤니티_추천_조회_요청_결과_검증;
import static com.depromeet.breadmapbackend.domain.post.PostControllerTestSteps.빵_이야기_상세_조회_요청;
import static com.depromeet.breadmapbackend.domain.post.PostControllerTestSteps.빵_이야기_작성_요청;
import static com.depromeet.breadmapbackend.domain.post.PostControllerTestSteps.커뮤니티_글_삭제_요청;
import static com.depromeet.breadmapbackend.domain.post.PostControllerTestSteps.커뮤니티_글_수정_요청;
import static com.depromeet.breadmapbackend.domain.post.PostControllerTestSteps.커뮤니티_글_좋아요_요청;
import static com.depromeet.breadmapbackend.domain.post.PostControllerTestSteps.커뮤니티_전체_카테고리_조회_요청;
import static com.depromeet.breadmapbackend.domain.post.PostControllerTestSteps.커뮤니티_추천_조회_요청;
import static com.depromeet.breadmapbackend.domain.post.PostTestData.preparePostData;
import static com.depromeet.breadmapbackend.domain.post.PostTestData.preparePostLikeData;
import static com.depromeet.breadmapbackend.domain.post.PostTestData.prepareReviewCommentData;
import static com.depromeet.breadmapbackend.domain.post.PostTestData.prepareReviewData;
