...
//        String oAuthId = "ADMIN_USER_FOR_EVENT_POST";
//        String keyword = "베이커리";
//        double latitude = 127.34;
//        double longitude = 36.78;
...
//
//        SearchResultResponse expectedResult = SearchResultResponse
//                .builder()
//                .subwayStationName("역삼역")
//                .searchResultDtoList(searchResultDtoList)
//                .build();
//
//        when(searchService.searchEngine(any(), any(), any(), any(), any()))
//                .thenReturn(expectedResult);
//
//        verify(searchService).searchEngine(
//                any(), any(), any(), any(), any());
//
