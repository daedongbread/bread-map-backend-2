...
=== 빵집 제보 이미지 조회 API [GET]
operation::admin/bakery/review/image[snippets='http-request,request-headers,path-parameters,request-parameters,http-response,response-fields']
