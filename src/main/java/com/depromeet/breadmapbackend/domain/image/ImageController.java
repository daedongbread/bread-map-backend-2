...
public class ImageController {
    ...
    @PostMapping("/multi")
    @ResponseStatus(HttpStatus.CREATED)
    public ApiResponse<List<ImageDto>> uploadImages(@RequestPart List<MultipartFile> images) throws IOException { // TODO 비동기
        return new ApiResponse<>(imageService.uploadImages(images));
    }
}
