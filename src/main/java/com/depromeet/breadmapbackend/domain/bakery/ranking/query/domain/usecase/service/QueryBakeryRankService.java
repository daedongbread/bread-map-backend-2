package com.depromeet.breadmapbackend.domain.bakery.ranking.query.domain.usecase.service;
...
import com.depromeet.breadmapbackend.domain.bakery.ranking.query.domain.QueryBakeryFlagCount;
import com.depromeet.breadmapbackend.domain.bakery.ranking.query.domain.QueryBakeryRank;
import com.depromeet.breadmapbackend.domain.bakery.ranking.query.domain.infrastructure.BakeryRanksCachingPublisher;
import com.depromeet.breadmapbackend.domain.bakery.ranking.query.domain.infrastructure.QueryBakeryRankRepository;
import com.depromeet.breadmapbackend.domain.bakery.ranking.query.domain.usecase.QueryBakeryRankUseCase;
...
public class QueryBakeryRankService implements QueryBakeryRankUseCase {
	...
	private final com.depromeet.breadmapbackend.domain.bakery.ranking.query.domain.infrastructure.QueryFlagBakeryRepository QueryFlagBakeryRepository;
