...
//    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .and()
                .authorizeRequests()
                .antMatchers("/v1/users/auth/reissue", "/v1/admin/join", "/v1/admin/login", "/v1/admin/reissue", "/exception/**").permitAll()
                .antMatchers("/h2-console/**", "/favicon.ico", "/actuator/health").permitAll()
                .antMatchers("/v1/bakeries/**", "/v1/flags/**", "/v1/reviews/**", "/v1/users/**", "/v1/notices/**", "/v1/search/**", "/v1/images/**").hasAuthority(RoleType.USER.getCode())
