...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .and()
                .authorizeRequests()
                .antMatchers("/v1/bakeries/**", "/v1/auth/valid", "/v1/auth/login", "/v1/auth/register", "/v1/auth/reissue", "/v1/exception/**").permitAll()
                ...
                .antMatchers("/v1/flags/**", "/v1/reviews/**", "/v1/users/**", "/v1/notices/**", "/v1/search/**", "/v1/images/**", "/v1/auth/**", "/notices/**").hasAuthority(RoleType.USER.getCode())
