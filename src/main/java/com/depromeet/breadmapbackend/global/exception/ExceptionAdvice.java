...
public class ExceptionAdvice {
	...
	protected ErrorResponse requestBodyNotValidException(HttpServletRequest request,
		MethodArgumentNotValidException e) {
		for (FieldError error : e.getBindingResult().getFieldErrors()) {
			log.error("error field : \"{}\", value : \"{}\", message : \"{}\"", error.getField(),
	...
	@ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
	protected ErrorResponse missingServletRequestPartException(HttpServletRequest request,
	...
	@ResponseStatus(HttpStatus.BAD_REQUEST)
	protected ErrorResponse pathVariableTypeMismatchException(HttpServletRequest request,
	...
	@ResponseStatus(HttpStatus.BAD_REQUEST)
	protected ErrorResponse pathVariableMissingException(HttpServletRequest request,
	...
	public ResponseEntity<ErrorResponse> daedongException(DaedongException e) {
		final String msg = e.getArgs() != null ?
			e.getDaedongStatus().getDescription().formatted(e.getArgs()) :
