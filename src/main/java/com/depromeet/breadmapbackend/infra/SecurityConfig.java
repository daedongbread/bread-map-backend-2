...
//                .antMatchers("/admin/**").hasAuthority(RoleType.ADMIN.getCode())
                .antMatchers("/bakery/**", "/flag/**", "/review/**", "/report/**", "/admin/**").hasAuthority(RoleType.USER.getCode())
//                .antMatchers("/bakery/**", "/flag/**", "/review/**", "/report/**", "/admin/**").hasAuthority(RoleType.ADMIN.getCode())
